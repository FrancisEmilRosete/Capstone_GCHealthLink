...
export default function ScannerWidget({ standalone = true }: { standalone?: boolean }) {
  ...
  return (
    <div className={`relative ${standalone ? 'p-4 sm:p-6 max-w-2xl mx-auto' : ''}`}>
      ...
      {status === 'found' && foundStudent ? (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 w-full">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 w-full">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={loading}
              className="mr-2 bg-teal-500 hover:bg-teal-600 text-white text-sm font-semibold px-5 py-2.5 rounded-xl transition-colors shrink-0 disabled:opacity-70"
            >

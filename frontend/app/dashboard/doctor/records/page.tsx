    ...
    <div className="p-4 sm:p-6 max-w-6xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">View patient visit history and clinical timelines.</p>
        </div>
      </div>
          ...
          {selectedVisit ? (
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden sticky top-6 max-h-[calc(100vh-120px)] overflow-y-auto">
              ...
              <div className="p-4 space-y-4">
                ...
                <Link
                  href={`/dashboard/doctor/records/${encodeURIComponent(selectedVisit.studentProfile.studentNumber)}`}

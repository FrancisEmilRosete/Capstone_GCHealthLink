          ...
          {selectedVisit ? (
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden sticky top-6 max-h-[calc(100vh-120px)] overflow-y-auto">
              ...
              <div className="p-4 space-y-4">
                ...
                <Link
                  href={`/dashboard/doctor/record/${encodeURIComponent(selectedVisit.studentProfile.studentNumber)}?returnTo=${encodeURIComponent('/dashboard/doctor/medical-tracking')}`}

...
export default function DentalNotificationsPage() {
    ...
    <div className="p-4 sm:p-6 space-y-5">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div>
            <h1 className="text-xl font-bold text-gray-900">Dental Notifications</h1>
            <p className="text-xs text-gray-400 mt-0.5">Dental queue alerts and clinic readiness updates</p>
          </div>
          {unread > 0 && (
